                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{url('student.update,[$student->id]')}}">
                        ...
                        <div class="form-group{{ $errors->has('admission_number') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input  type="text" id="search" class="form-control{{ $errors->has('admission_number') ? ' is-invalid' : '' }}" name="admission_number" value="{{ old('$student->admission_number',$student->admission_number) }}" placeholder="">
